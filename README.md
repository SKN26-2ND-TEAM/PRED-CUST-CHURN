...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="5">박기은</td>
      <td>김이선</td>
      웹페이지 디자인에서 색감과 구성 요소를 개선하며 전체적인 완성도를 높였고, 스트림릿 화면의 초기 기획과 UI/UX 설계를 주도하며 프로젝트의 방향성을 잡았습니다. 또한 기능 개발에서도 안정적인 구현으로 핵심 역할을 수행했으며, 모델 성능 향상을 위해 지속적인 실험과 개선을 이어갔습니다. 더불어 모델 선택 과정에서도 팀에 명확한 기준과 동기를 제공했고, README, 회의록, 노션 정리 등 문서화 작업에도 꾸준히 기여하며 협업 효율을 높였습니다.
      <td></td>
    </tr>
    <tr>
      <td>박은지</td>
