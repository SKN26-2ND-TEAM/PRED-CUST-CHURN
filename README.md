...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="5">박기은</td>
      <td>김이선</td>
      웹페이지 디자인에서 색감과 구성 요소를 개선하며 전체적인 완성도를 높였고, 스트림릿 화면의 초기 기획과 UI/UX 설계를 주도하여 프로젝트의 방향성을 명확히 했습니다. 또한 기능 개발에서도 안정적인 구현을 통해 핵심 역할을 수행했으며, 모델 성능 향상을 위해 지속적인 실험과 개선을 이어갔습니다. 더불어 모델 선택 과정에서도 팀에 명확한 기준을 제시했고, README, 회의록, 노션 정리 등 문서화 작업에도 꾸준히 기여하며 협업 효율을 높였습니다.
      <td></td>
    </tr>
    <tr>
      <td>박은지</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="5">박은지</td>
      <td>김이선</td>
      프로젝트에 적합한 데이터셋을 선별하는 과정에서 중요한 역할을 해주셨으며, 컨디션이 좋지 않은 상황에서도 끝까지 발표 준비와 자료 정리를 책임감 있게 수행해주셨습니다. 또한 개인적인 경험을 바탕으로 주제 선정 방향에 의미 있는 의견을 더해주셨고, 프로젝트 전반에 대한 높은 이해도를 바탕으로 전달력 있는 발표를 보여주셨습니다. 더불어 도메인 지식을 활용해 단순 구현을 넘어 실질적인 비즈니스 관점의 해석을 더해주셨으며, 진정성 있는 발표 덕분에 프로젝트가 인상 깊게 마무리될 수 있었습니다.
      <td></td>
    </tr>
    <tr>
      <td>박기은</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="5">위희찬</td>
      <td>김이선</td>
      프로젝트의 핵심인 머신러닝 모델링을 중심으로 학습부터 성능 개선까지 전반을 주도하며 예측 결과의 완성도를 높이는 데 기여하셨습니다. 다양한 모델을 비교·검증하고, 하이퍼파라미터와 임계값을 세밀하게 조정하는 등 꾸준한 실험을 통해 최적의 성능을 도출해내신 점이 특히 인상적이었습니다. 또한 모델 학습 결과를 체계적으로 정리해주셨을 뿐만 아니라, 실제 사용자 화면과 연동되는 과정까지 맡아 구현하며 프로젝트의 완성도를 높여주셨습니다.
      <td></td>
    </tr>
    <tr>
      <td>박기은</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="5">이선호</td>
      <td>김이선</td>
      가설 설정부터 모델 학습, 화면 구성까지 다양한 관점에서 핵심 포인트를 짚어주시며 발전 방향을 제시해주셨습니다. 또한 프로젝트 진행 중에도 개발 방향을 잘 잡아주셔서 안정적인 흐름을 유지할 수 있었습니다. 더불어 팀원들의 의견을 경청하고 조율하며 유연한 분위기를 만들어주셨고, 다양한 아이디어로 프로젝트 방향 설정에 큰 도움을 주셨습니다.
      <td></td>
    </tr>
    <tr>
      <td>박기은</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="5">홍지윤</td>
      <td>김이선</td>
      프로젝트 진행 중 방향을 잘 잡아 안정적인 흐름을 유지할 수 있도록 도와주셨습니다. 또한 다양한 아이디어로 방향 설정에 큰 도움을 주셨으며, 프로젝트 구조를 설계해 전체 흐름을 정리하고 데이터 전처리 함수 제작 등으로 효율적인 작업 환경을 구축하여 협업과 생산성 향상에 기여하셨습니다. 더불어 전반적인 작업에서도 적극적으로 어시스트를 해주셔서 프로젝트의 효율과 성과를 높이는 데 큰 역할을 해주셨습니다.
      <td></td>
    </tr>
    <tr>
      <td>박기은</td>
